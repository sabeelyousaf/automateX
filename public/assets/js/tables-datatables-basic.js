  ...
  if (dt_basic_table.length) {
    dt_basic = dt_basic_table.DataTable({
      ...
      buttons: [
        ...
        {
          text: '<i class="ti ti-plus me-sm-1"></i> <span class="d-none d-sm-inline-block border-0">Add New File</span>',
    ...
    $('div.head-label').html('<h5 class="card-title mb-0">All Files</h5>');
  }
